...
├── Trading Fees (Spot + Perp)          → 60% of revenue
├── Aggregation/Routing Fees            → 15% of revenue
├── Cross-chain Settlement Fees         → 10% of revenue
├── Bot Platform Subscription           →  8% of revenue
├── Plugin Marketplace Commission       →  5% of revenue
└── AI Premium Subscriptions            →  2% of revenue
